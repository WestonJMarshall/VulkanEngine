...
#pragma region DebugShapes
	...
	/// <summary>
	/// Draws a wireframe cube at the specified position and orientation
	/// </summary>
	/// <param name="position">The position to draw the cube</param>
	/// <param name="orientation">The rotation of the cube</param>
	/// <param name="color">The color of the cube</param>
	/// <param name="size">The length width and height of the cube</param>
	/// <param name="duration">The duration to draw the cube for, -1 to draw indefinetly, 0 for only the current frame</param>
	void DrawWireCube(glm::vec3 position, glm::quat orientation, glm::vec3 color, glm::vec3 size = glm::vec3(1.0f, 1.0f, 1.0f), float duration = -1.0f);
