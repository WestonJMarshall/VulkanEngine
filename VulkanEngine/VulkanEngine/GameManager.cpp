...
void GameManager::Init()
{
	...
	for (int i = 0; i < 75; i++) {
		...
		gameObjects[i]->AddComponent<Transform>(std::make_shared<Transform>(glm::vec3()));;
		if (i >= 50 && i <= 75) {
		...
		gameObjects[i]->SetPhysicsObject(PhysicsLayers::Trigger, ColliderTypes::ARBB, 1.0f, false);
