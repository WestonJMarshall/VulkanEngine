...
void BinaryPartitionTree::BSP_Generate_Children()
{
	...
	std::shared_ptr<BinaryPartitionTree> child1 = std::make_shared<BinaryPartitionTree>(new BinaryPartitionTree());
	...
	std::shared_ptr<BinaryPartitionTree> child2 = std::make_shared<BinaryPartitionTree>(new BinaryPartitionTree());
...
void BinaryPartitionTree::BSP_Clear_Node_Specific(std::shared_ptr<BinaryPartitionTree> bsp, bool root = true)
{
